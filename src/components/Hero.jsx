...
const Hero = () => {
  ...
  return (
    <div className="h-screen">
      ...
      <div className="bg-red p-4 flex flex-row gap-4">

        <div className="bg-black w-1/2 max-md:w-full h-[96vh] flex justify-center items-center flex-col gap-10">
          <h2 className="text-red text-6xl font-black max-md:text-5xl text-center p-6 max-md:max-w-2xl">
            Building Awesome Software with a{" "}
            <span className="text-white">Twist</span>
          </h2>

          <div className=" md:hidden flex justify-center items-center w-2">
          <Image
          ...
          <h2 className="text-yellow-300 font-bebas text-4xl max-md:text-3xl p-6 shadow-lg shadow-red max-md:max-w-xl border-dashed border-[3px]">
            {array[currentIndex].text}
          </h2>
          <div className="flex items-end">
            <button className="text-black bg-red font-bold text-xl bg-red-500 rounded-lg px-6 py-3 hover:bg-red hover:text-white transition-transform duration-1000 ease-in-out transform hover:scale-110">
              Pool us
            </button>
          </div>
        </div>
